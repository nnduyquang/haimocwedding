...
@section('container')
    ...
    @endif
    {!! Form::open(array('route' => 'aocuois.store','method'=>'POST','files'=>true)) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ Html::image('','',array('id'=>'showAnhAoCuoi','class'=>'showAnhAoCuoi'))}}

            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <button id="btnDichVu" type="submit" class="btn btn-primary">Thêm Áo Cưới</button>
        </div>
    </div>
    {!! Form::close() !!}
@stop
