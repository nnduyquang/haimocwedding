...
@section('container')
    ...
    @endif
    {!! Form::model($danhmucaocuoi,array('route' => ['danhmucaocuois.update',$danhmucaocuoi->id],'files'=>true,'enctype' => 'multipart/form-data','method'=>'PATCH')) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {{ Html::image('images/temps/'.$danhmucaocuoi->anhdaidien,'',array('id'=>'showAnhDaiDienDanhMuc','class'=>'showAnhDaiDienDanhMuc'))}}

            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12 text-center">
            <button id="btnDichVu" type="submit" class="btn btn-primary">Cập Nhật Danh Mục Áo Cưới</button>
        </div>
    </div>
    {!! Form::close() !!}
@stop
